...
(function(exports) {
  ...
  var 
    ...
    // TODO: Add checks for image, canvas, or context
    // Currently expects canvas
    fuzzy = function (obj) {
      var data, tempContext;
      ...
      if(obj instanceof HTMLImageElement) { // in an image
        ...
        canvas.height = obj.height;
        originalCanvas = obj;
        tempContext = originalCanvas.getContext("2d");
        data = tempContext.getImageData(0, 0, canvas.width, canvas.height);
        context.putImageData(data, 0, 0);
      }
      else if(obj instanceof CanvasRenderingContext2D) { // is 2d context
        console.log('ctx');
        
        originalCanvas = obj.canvas;
