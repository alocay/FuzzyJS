...
(function(window) {
 ...
 /**
  ...
  /**
   * Simple scaling tool - Simply creates a new canvas with the given width/height and places the currently stored Canvas data onto this new Canvas. 
   * Not the best scaling tool but does the job for simple work.
   * 
