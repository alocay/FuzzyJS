...
(function(window) {
   ...
   * @return {Object} Returns this instance of `fuzzy`
   * @api public
   */
   ...
   * @return {Object} Returns this instance `fuzzy`
   * @api public
   */
   ...
   * 
   * @method draw
   * @param {Object} (Optional) An HTMLImageElement to place the altered canvas' contents into
   * @param {Object} (Optional) Various options
   ...
   * @return {Object} Returns a new image with the new dimensions and containing the canvas content
   * @api public
   */
